function [BW,maskedRGBImage] = RipeMask(RGB)
...
shiftVec = [0.067374 0.018210 0.515253];
I = I - shiftVec;
I = [I ones(size(I,1),1)]';

% Apply transformation matrix
tMat = [-0.322251 -0.774928 0.000000 0.674224;
    -0.010812 0.007021 0.970249 -0.496208;
    0.620053 -0.402619 0.016919 8.438443;
...
hPoints(1).data = [0.060967 -0.960773;
    0.000000 0.015471;
    0.721742 -0.011921;
    0.716363 -0.410746;
    0.639257 -0.566331;
