function [BW,maskedRGBImage] = OverripeMask(RGB)
...
shiftVec = [0.018024 0.024861 0.566329];
I = I - shiftVec;
I = [I ones(size(I,1),1)]';

% Apply transformation matrix
tMat = [-1.334376 -0.180058 -0.000000 0.582684;
    0.008384 -0.032990 0.882370 -0.486120;
    0.246958 -0.971778 -0.029955 9.077587;
...
hPoints(1).data = [0.008523 -0.133496;
    0.000000 -0.978905;
    0.904245 -1.005602;
    0.430039 -0.204688];
